                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="lg:text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                            Mananging and growing a business in today's
                            ultra-competitive internet econonmy ain't easy. We
                            handle the tough stuff so you can focus on your
                            patients.
                        </p>
                    </div>
                            ...
                            <div className="flex">
                                <div className="flex-shrink-0">
                                    <div className="flex items-center justify-center h-12 w-12 rounded-md text-white">
                                        ...
                                        >
                                            <path d="M23.3333 1.88L7.33333 17.88L0 10.5467L1.88 8.66667L7.33333 14.1067L21.4533 0L23.3333 1.88Z" />
                                        </svg>
                                    </div>
                                </div>
                                <div className="ml-4">
