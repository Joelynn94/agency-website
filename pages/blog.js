				...
				<div className="relative flex justify-center">
					<div className="relative">
						<div className="p-20 text-center bg-white custom_color_border-thick">
							...
							<a
								className="inline-block uppercase text-center cursor-pointer font-semibold px-5 py-2 lg:px-10 border bg-gray-900 text-gray-50 mx-2 lg:mx-8 transition-all duration-300 shadow-sm hover:bg-gray-700 hover:shadow-md focus:ring-2 focus:ring-blue-300"
								href="/pricing.html"
							>
								View Pricing
							</a>
