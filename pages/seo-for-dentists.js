		...
		<Layout>
			<div className="py-32 md:py-40 bg-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="max-w-prose mx-2 lg:mx-auto mb-24 lg:mb-40 text-gray-600">
						<p className="my-16 px-4 py-4 lg:px-8 rounded-md text-center text-lg lg:text-xl font-semibold text-green-800 bg-green-50">
				...
				<div className="flex flex-col lg:flex-row items-center justify-between">
					<div>
						<h2 className="text-2xl font-bold text-white mb-4">
							Our SEO strategy will get you ranking!
						</h2>
