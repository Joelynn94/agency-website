		...
		<Layout>
			<div className="py-32 md:py-40 bg-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="lg:text-center mb-8 lg:mb-20">
					...
					<section className="lg:pt-24 pb-32 lg:pb-40">
						<div className="flex flex-col items-center mx-4 md:w-2/3 md:mx-auto lg:w-full lg:mx-0">
							<div className="flex flex-col-reverse items-center justify-center lg:flex-row gap-x-14">
								<div className="lg:w-1/4">
									...
									<p className="leading-relaxed my-6 text-gray-700">
										...
										adipiscing elit. Massa in arcu venenatis
										est laoreet habitant nibh. Eu proin
										egestas consequat pharetra sit volutpat
										consectetur mauris. Scelerisque ac
										lectus vitae, amet sed vel molestie dui.
										Ullamcorper.
									</p>
								</div>
								<div className="relative lg:rounded-xl h-auto lg:w-96 mt-0 -mx-4 lg:mx-0 overflow-hidden mb-8">
									<img
										className="h-full w-full object-cover"
										src="./images/ppc_device_1.png"
										alt=""
									/>
								</div>
							</div>
						...
						<div className="flex flex-col items-center mx-4 md:w-2/3 md:mx-auto lg:w-full lg:mx-0 my-20">
							<div className="flex flex-col-reverse items-center justify-center lg:flex-row-reverse gap-x-14">
								<div className="lg:w-1/4">
									<h2 className="inline-block text-xl font-semibold uppercase text-gray-800">
								...
								<div className="relative lg:rounded-xl h-80 lg:w-96 mt-0 -mx-4 lg:mx-0 overflow-hidden mb-8">
									<img
										className="h-full w-full object-cover"
										src="./images/ppc_device_2.png"
										alt=""
									/>
								</div>
							</div>
				...
				<div className="flex flex-col lg:flex-row items-center justify-between">
					<div>
						<h2 className="text-2xl font-bold text-white mb-4">
							Let the experts handle your ads!
						</h2>
						<span className="inline-block w-full mt-4 text-center lg:mt-0 lg:text-left font-medium text-gray-200">
							If you have a website,{" "}
							<a href="tel:0823253551" className="underline">
								call us
							</a>{" "}
							for a{" "}
							<span className="font-bold italic text-gray-100">
								{" "}
								free site analysis.
							</span>
						</span>
					...
					>
						...
						<div className="w-full md:w-80">
							<div className="relative">
								...
								<button
									type="submit"
									className="uppercase px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2 bg-blue-500 text-blue-50 hover:bg-blue-700"
								>
									Message Me
								</button>
								<span
								...
								<span
									id="error"
									className="hidden mt-2 px-4 py-2 font-medium border rounded-sm border-red-500 bg-red-100 text-red-600"
								>
