        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-col-reverse items-center justify-center lg:flex-row gap-x-14">
                <div className="lg:w-1/4">
                  ...
                  <p className="leading-relaxed my-6 text-gray-700">
                    ...
                    egestas consequat pharetra sit volutpat consectetur mauris.
                    Scelerisque ac lectus vitae, amet sed vel molestie dui.
                    Ullamcorper.
                  </p>
                </div>
          ...
          <div className="">
            <h1 className="text-4xl font-semibold text-center mb-16">
              <span className="text-gray-900 tracking-wide">How We Do It</span>
            </h1>
