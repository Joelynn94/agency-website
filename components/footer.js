    ...
    <footer className="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-12 xl:px-32 2xl:px-56 pt-12 pb-20 md:pt-24">
      <div className="flex flex-col lg:flex-row">
        <div className="w-full md:w-1/2 lg:w-2/6 lg:mx-4 lg:pr-8">
          <h3 className="font-bold text-2xl">Dentist Marketing</h3>
          ...
          >
            ...
            <div className="w-full">
              ...
              <div className="relative">
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-blue-500 to-green-400 text-white hover:from-green-400 hover:to-blue-500 px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2"
                >
                  Subscribe
                </button>
                <span
        ...
        <div className="w-full md:w-1/8 lg:w-1/6 mt-20 lg:mt-0 lg:mx-4">
          ...
          <ul className="mt-4">
            <li className="mt-2">
              <Link href="/our-work">
                <a title="" className="opacity-75 hover:opacity-100">
                  Our Work
                </a>
              </Link>
            </li>
          ...
          <ul className="mt-4">
            <li>
              ...
              >
                ...
                <span className="ml-3">3 Abbey Rd, London, United Kingdom</span>
              </a>
            </li>
            <li className="mt-4">
              <a
            ...
            <li className="mt-4">
              ...
              >
                ...
                <span className="ml-3">(+27) 81 343 4552</span>
              </a>
            </li>
            <li className="mt-4">
              <a
              ...
              >
                ...
                <span className="ml-3">agency@mail.com</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="flex w-full flex-col items-center text-xs mt-12">
        <Link href="/privacy-policy">
          <a className="text-gray-400 hover:text-gray-300" rel="nofollow">
            Privacy Policy
          </a>
        </Link>
